...
<div class="row">
    ...
    <div class="col-lg-4 col-sm-12">
        <div class="card">
            <div class="card-header">
                <i class="fa fa-align-justify"></i> Tambah Program Studi</div>
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('admin.study.store') }}" id="addStudy" method="post">
                    @csrf
                    <div class="form-group row">
                        <label class="col-md-12 col-form-label" for="text-input">Program Studi</label>
                        <div class="col-md-12">
            ...
            <div class="card-footer">
                <button class="btn btn-sm btn-primary" type="submit" onclick="event.preventDefault();
                        document.getElementById('addStudy').submit();">
    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header">
                <i class="fa fa-align-justify"></i> Data Program Studi</div>
            <div class="card-body">
...
<script>
    $('#table-role').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "{{ route('admin.study.index.json') }}",
        },
        columns: [
            {
                data: 'name',
